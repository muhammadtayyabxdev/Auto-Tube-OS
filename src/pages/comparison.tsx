...
export default function Comparison() {
  ...
  return (
    <>
      <Head>
        <title>AutoTube OS vs The Competition — AutoTube OS</title>
        <meta name="description" content="Compare AutoTube OS with manual workflows, separate tools, and see why unified workflows save 73% time." />
      </Head>
