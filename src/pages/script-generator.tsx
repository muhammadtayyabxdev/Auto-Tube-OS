...
export default function ScriptGenerator() {
  ...
  return (
    <>
      <Head>
        <title>AI Script Generator — AutoTube OS</title>
        <meta name="description" content="Generate retention-optimized, high-conversion scripts in 12+ documentary, horror, and finance formats." />
      </Head>
      <Suspense fallback={
      <div 
        style={{
