...
export default function Blog() {
  ...
  return (
    <>
      <Head>
        <title>Creator Blog & Insights — AutoTube OS</title>
        <meta name="description" content="Discover YouTube automation guides, viral title strategies, retention hacks, and creator growth tutorials." />
      </Head>
