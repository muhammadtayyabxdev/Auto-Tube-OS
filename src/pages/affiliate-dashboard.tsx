...
export default function AffiliateDashboard() {
  ...
  return (
    <div className={styles.app}>
      <Head>
        <title>Affiliate Dashboard — AutoTube OS</title>
        <meta name="description" content="Track your referral links, view real-time clicks, pending payouts, and recurring commission stats." />
      </Head>
