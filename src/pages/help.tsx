...
export default function HelpCenter() {
  ...
  return (
    <>
      <Head>
        <title>Help Center & Knowledge Base — AutoTube OS</title>
        <meta name="description" content="Search tutorials, FAQs, API integration guides, and learn how to optimize your channel workflow." />
      </Head>
