...
export default function Changelog() {
  ...
  return (
    <>
      <Head>
        <title>What's New (Changelog) — AutoTube OS</title>
        <meta name="description" content="Keep track of new features, minor upgrades, and enhancements to our YouTube creator tools." />
      </Head>
