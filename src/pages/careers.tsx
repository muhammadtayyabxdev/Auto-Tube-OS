...
export default function Careers() {
  ...
  return (
    <>
      <Head>
        <title>Careers & Open Roles — AutoTube OS</title>
        <meta name="description" content="Join our mission-driven team and help us build the next generation of AI agents for content creators." />
      </Head>
