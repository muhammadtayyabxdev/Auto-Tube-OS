...
export default function Onboarding() {
  ...
  const { loading } = useAuth(true); // requireAuth = true: redirects to auth if logged out
  ...
  return (
    <div className={styles.shell}>
      <Head>
        <title>Onboarding & Setup — AutoTube OS</title>
        <meta name="description" content="Quickly set up your first YouTube channel workspace and define your target audience and niche." />
      </Head>
