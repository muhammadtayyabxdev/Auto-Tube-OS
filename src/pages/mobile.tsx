...
export default function MobilePromo() {
  ...
  return (
    <>
      <Head>
        <title>Mobile Companion App — AutoTube OS</title>
        <meta name="description" content="Keep track of your publication pipeline and approval requests directly from your iOS/Android device." />
      </Head>
