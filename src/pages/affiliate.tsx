...
export default function Affiliate() {
  ...
  return (
    <>
      <Head>
        <title>Affiliate Program — AutoTube OS</title>
        <meta name="description" content="Partner with AutoTube OS and earn up to 30% recurring commission for life. Join our high-paying creator affiliate program." />
      </Head>
