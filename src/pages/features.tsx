...
export default function FeaturesPage() {
  ...
  return (
    <>
      <Head>
        <title>Features & AI Tools — AutoTube OS</title>
        <meta name="description" content="Explore 7 unified modules including Viral Topic Finder, AI Script Writer, Thumbnail Engine, and Shorts Repurposer." />
      </Head>
